...
public class StringList {
    ...
    public String toString() {
        ...
        sb.append("[");
        while (aux != null) {
            // Se añade el valor a la representación
            sb.append(aux.data);
    ...
    /**
     * Operación ObtenerPrimerElemento()
     * @return: el primer elemento si la lista no está vacía, null en caso contrario
     */
    public String getFirst() {
        if (first != null) return first.data;
        return null;
        // return (first != null) ? first.data : null; // implementación alternativa con operador ternario
    }

    /**
     * Método que devuelve la misma información como un ArrayList
     * @return
     */
